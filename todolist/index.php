...
<html>
 ...
 <body>
  ...
  <br />
  <div class="container">
   <h1 align="center">helpdesk support</h1>
   <br />
     ...
     <div class="row">
      ...
      <div class="panel-body">
       ...
       foreach($result as $row)
       {
        ...
        echo '<a href="#" style="'.$style.'" class="list-group-item" id="list-group-item-'.$row["task_list_id"].'" data-id="'.$row["task_list_id"].'">'.$row["task_details"]."                 ".$row["time"].' <span class="badge" data-id="'.$row["task_list_id"].'">X</span></a>';
       }
       ?>
       </div>
      </div>
