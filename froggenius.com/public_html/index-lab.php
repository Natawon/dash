  ...
  <body id="page-top">
    ...
    <section id="aboutus">
      <div class="container text-center">
          <h1 class="d-none d-md-block"><span class="text-primary"><?=$txtathena?></span> <span class="text-subprimary"><?=$txtelearning?></span></h1>
          <h1 class="d-block d-md-none"><span class="text-primary"><?=$txtathena?></span><br><span class="text-subprimary"><?=$txtelearning?></span></h1>
