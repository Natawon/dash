...
?>
    ...
    <p style="color: #218c74; font-size: 1.3em; text-align: center; margin-top: 20px; font-family: 'Prompt', sans-serif;">หน้าตรวจสอบแล้วของระบบลงทะเบียนผู้บริจาคเงิน</p>
            ...
            ";
                    ...
                    <td>
                       <!--  <a href="#out<?php echo $id;?>" data-toggle="modal"><button type='button' class='btn btn-default btn-sm'><span class='glyphicon glyphicon-minus' aria-hidden='true'></span></button></a>
                        ...
                        elseif ($row['Status']==1) {
                         echo "<font color='green'> ตรวจสอบแล้ว (แต่ยังไม่มีเลข)<i class='fas fa-check-circle'></i></font>"."<br>"."<br>";
                        }
                        // elseif ($var['status']==2) {
                        ...
                        if(isset($_POST['update_item1'])){
                           $id = $_POST['id'];
                            ...
                            $sql = "UPDATE donate SET 
                                ...
                                WHERE id='$id' ";
                            if ($conn->query($sql) === TRUE) {
                                echo '<script>window.location.href="checked.php"</script>';
                            } else {
                                echo "Error updating record: " . $conn->error;
                            }
                        }
