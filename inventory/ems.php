    ...
    <bodyy onload="myFunction()" style="margin:0;">
        ...
        <div class="container">
            <div class="dropdown">
                ...
                <a href="inventory.php"><button type='button' class='btn btn-success btn-sm'><i class="fas fa-chevron-left"></i>&nbsp; Back</button></a>

                 <a href="send.php" ><button type='button' class='btn btn-info btn-sm'><i class="fas fa-check"></i>&nbsp;เลือกจัดส่งแล้ว</button></a>
                <a href="wait.php"><button type='button' class='btn btn-info btn-sm'><i class="fas fa-check"></i>&nbsp;ยังไม่ได้ตรวจสอบ</button></a>
                 <a href="have_ems.php"><button type='button' class='btn btn-info btn-sm'><i class="fas fa-check"></i>&nbsp;มี EMS</button></a>   
            ...
            <table id="example" class="display nowrap" cellspacing="0" width="100%">
                ...
                <tbody>
                    <?php 
                    $sql = "SELECT customer.Cus_id,customer.Name,donate.Bill,donate.Record_date,donate.Amount,donate.Bank,donate.Slip,donate.Ems,donate.Status,donate.id,COUNT(donate.Ems)as test
    FROM customer 
    INNER JOIN donate
    ON customer.Cus_id=donate.Cus_id 
    WHERE donate.Ems=''
    GROUP by customer.Cus_id
    HAVING COUNT(donate.Ems='') ";
                    ...
                    <td>
                       <!--  <a href="#out<?php echo $id;?>" data-toggle="modal"><button type='button' class='btn btn-default btn-sm'><span class='glyphicon glyphicon-minus' aria-hidden='true'></span></button></a>
                        <div class='btn-group' role='group' aria-label='...'>
                            ...
                            <?php if($EMS==""){
                            echo "<font color='red'> ยังไม่มีเลข EMS <i class='fas fa-info-circle'></i> </font>"."<br>"."<br>";
                        }
                        ...
                        // }
                             ...
                             echo "<font color='#227093'> โปรดตรวจสอบ <i class='fas fa-cart-arrow-down'></i></font>"."<br>"."<br>";
                           ...
                           <!--  <a href="#view<?php echo $id;?>" data-toggle="modal"><button type='button' class='btn btn-primary btn-sm'><span class='glyphicon glyphicon-eye-open' aria-hidden='true'></span></button></a> -->
                            <!-- <a href="#edit<?php echo $id;?>" data-toggle="modal"><button type='button' class='btn btn-warning btn-sm'>เพิ่มเลขอ้างอิง&nbsp;<span class='glyphicon glyphicon-edit' aria-hidden='true'></span></button></a> -->
          ...
          <strong>Username</strong> Not Found.
                        ...
                        if(isset($_POST['update_item1'])){
                            ...
                            $sql = "UPDATE donate SET 
                                ...
                                WHERE id='$id' ";
                            if ($conn->query($sql) === TRUE) {
                                echo '<script>window.location.href="ems.php"</script>';
                            } else {
                                echo "Error updating record: " . $conn->error;
                            }
                        }
