...
CPA-DONATE        </a>
      ...
      <div class="sidebar-wrapper">
            <a class="navbar-brand" href="inventory.php">&nbsp;&nbsp;&nbsp;<i class="fas fa-external-link-alt"></i>ไปหน้าจัดการทั้งหมด</a>
...
<!--             <a class="navbar-brand" href="inventory.php"><i class="fas fa-external-link-alt"></i>ไปหน้าจัดการทั้งหมด</a>
 -->          </div>
      ...
      <!-- End Navbar -->
      <div class="content">
<p style="color: #218c74; font-size: 1.3em; text-align: center;  font-family: 'Prompt', sans-serif%; margin-top: -30px">ภาพรวมทั้งหมด</p>        <div class="container-fluid">
          <div class="row">
            <div class="col-sm-6">
              <div class="card card-stats">
                <div class="card-header card-header-warning card-header-icon">
                  ...
                  <p class="card-category">ผู้บริจาค</p>
                  <?php foreach ($result as $value){ 
                    ...
                    ?>
                  <h3 class="card-title"><?php echo $total; ?>
            ...
            <div class="col-sm-6">
              <div class="card card-stats">
                <div class="card-header card-header-success card-header-icon">
                  ...
                  <p class="card-category">จำนวนเงิน</p>
                  <h3 class="card-title"><?php echo number_format($total1); ?>                                      <small>บาท</small>
</h3>
                ...
                <div class="modal-dialog modal-md">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <p>
                                <div class="alert alert-danger">คุณต้องการออกระบบหรือไม่ <strong><?php echo $_SESSION['user_name']; ?>?</strong></p>
                            </div>
