...
?>
    ...
    <bodyy onload="myFunction()" style="margin:0;">
            <p style="color: #218c74; font-size: 1.3em; text-align: center; margin-top: 20px; font-family: 'Prompt', sans-serif;">หน้าภาพรวมทั้งหมดของระบบลงทะเบียนผู้บริจาคเงิน</p>
        <div class="container">
            <div class="dropdown">
                ...
                <!-- <a href="have_ems.php"><button type='button' class='btn btn-success btn-sm'><i class="fas fa-check"></i>&nbsp;มี EMS</button></a>
                 ...
                 <a href="checked.php"><button type='button' class='btn btn-success btn-sm'><i class="fas fa-check"></i>&nbsp;ตรวจสอบแล้ว</button></a>
                  <a href="send.php"><button type='button' class='btn btn-success btn-sm'><i class="fas fa-check"></i>&nbsp;จัดส่งแล้ว</button></a>
                   <a href="dashboard.php"><button type='button' class='btn btn-primary active'><i class="fab fa-dashcube"></i>&nbsp;ไปหน้า dashboard</button></a>
            </div><br>
            ...
            ";
                    ...
                    <td>
                            ...
                            <a href="#edit<?php echo $id;?>" data-toggle="modal"><button type='button' class='btn btn-warning btn-sm'>แก้ไขเลขอ้างอิง&nbsp;<span class='glyphicon glyphicon-edit' aria-hidden='true'></span></button></a>
                             <a href="#edit10<?php echo $id;?>" data-toggle="modal"><button type='button' class='btn btn-warning btn-sm'>แก้ไขเลขEMS&nbsp;<span class='glyphicon glyphicon-edit' aria-hidden='true'></span></button></a>
