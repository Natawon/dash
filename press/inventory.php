...
?>
    ...
    <bodyy onload="myFunction()" style="margin:0;">
        ...
        <a href="#add" data-toggle="modal"><button type='button' class='btn btn-primary btn-sm'><i class="fas fa-check" ></i>&nbsp;Add</button></a>
            <hr>
            ...
            <table id="example" class="display nowrap" cellspacing="0" width="100%">
                ...
                <tbody>
                    <?php 
                    $sql = $conn->prepare("SELECT id,name,web,sale,date_start, date_expire, DATEDIFF(date_expire, date_start) as ddiff FROM domain order by 'id', ddiff ");
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        while($row = $result->fetch_assoc()) {
                            ...
                            $item_web = $row['web'];
                            $item_sale = $row['sale'];
                            $item_dstart= $row['date_start'];
                            $item_dexpire = $row['date_expire'];

                            // $item_description = $row['count'];
                            // $critical_lvl = $row['unit'];
                            // $Status = $row['price_tag'];
                            // $Slip = $row['price_total'];
                            // $EMS = $row['Ems'];
                    ...
                    <td>
                       <!--  <a href="#out<?php echo $id;?>" data-toggle="modal"><button type='button' class='btn btn-default btn-sm'><span class='glyphicon glyphicon-minus' aria-hidden='true'></span></button></a>
                        <div class='btn-group' role='group' aria-label='...'>
                            ...
                            <a href="#edit<?php echo $id;?>" data-toggle="modal"><button type='button' class='btn btn-warning btn-sm'>แก้ไข expire&nbsp;<span class='glyphicon glyphicon-edit' aria-hidden='true'></span></button></a>
                                ...
                                <div class="modal-body">
                                    <form method="post" class="form-horizontal" role="form">
                                        <div class="form-group">
                                            <label class="control-label col-sm-2" for="name">test:</label>
                                            <div class="col-sm-3">
                                                <input type="hidden" name="add_stocks_id" value="<?php echo $id; ?>">
                                                <input type="text" class="form-control" id="item_name" name="item_name" placeholder=" Name" required readonly value="<?php echo $name; ?>">
                                            </div>
                                            <label class="control-label col-sm-2" for="item_code">link:</label>
                                            <div class="col-sm-2">
                                                <input type="text" class="form-control" id="item_code" name="item_code" placeholder="web_link" required readonly value="<?php echo $web; ?>">
                                            </div>
        ...
        <div id="add2<?php echo $id; ?>" class="modal fade" role="dialog">
                        <div class="modal-dialog modal-lg">
                            <!-- Modal content-->
                            <div class="modal-content">
                                <div class="modal-header">
                ...
                <div class="modal-dialog modal-lg">
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <img src="upload/<?php echo $Slip; ?>" class="img-rounded" width="400px" height="450px" style="margin-left: 250px;" />
                        </div>
                ...
                <div class="modal-dialog modal-lg">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label class="control-label col-sm-2" for="item_name">Add:</label>
                                <div class="col-sm-4">
                                    <input type="text" class="form-control" id="name" name="name" value="<?php echo $item_name; ?>" placeholder="Item name" required autofocus>
                ...
                <div class="modal-dialog modal-lg">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form method="post" class="form-horizontal" role="form">
                                <div class="form-group">
                                    <label class="control-label col-sm-2" for="item_name">Name:</label>
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control" id="item_name" name="item_name" placeholder="Name" autofocus required>
                                    </div>
                                    <label class="control-label col-sm-2" for="item_code">web:</label>
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control" id="item_code" name="item_code" placeholder="web" required>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-sm-2" for="item_category">Category:</label>
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control" id="item_sale" name="item_sale" placeholder="Sale" required>
                                    </div>    
                                </div>
                                <div class="form-group">
                                    
                                    <label class="control-label col-sm-2" for="item_category">date_start:</label>
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control" id="item_sale" name="item_dstart" placeholder="date_start" required>
                                    </div>
                                    <label class="control-label col-sm-2" for="item_category">date_expire:</label>
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control" id="item_sale" name="item_dexpire" placeholder="date_expire" required>
                                    </div>
