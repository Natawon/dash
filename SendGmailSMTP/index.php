...
require_once('PHPMailer/PHPMailerAutoload.php');
	...
	$mail->Username = "natawon9@gmail.com"; //ให้ใส่ Gmail ของคุณเต็มๆเลย
	$mail->Password = "Natawon99"; // ใส่รหัสผ่าน
	...
	$mail->FromName = "Test Send Email"; //ชื่อที่ใช้ในการส่ง
	...
	$mail->AddAddress('nathaworn.pa.dootvmedia@gmail.com','Recive Name'); //อีเมล์และชื่อผู้รับ
